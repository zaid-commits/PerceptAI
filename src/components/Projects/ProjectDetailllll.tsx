...
const fallbackProject: Project = {
  ...
  elaboratedDescription: "This is a more detailed fallback project description.",
  coverImage: "fallback-image-url",
  tags: ["fallback", "project"],
  category: "Fallback Category",
  createdAt: new Date().toISOString(),
  githubUrl: "https://github.com/fallback",
  liveUrl: "https://fallback.com",
  author: {
    name: "Fallback Author",
    avatar: "fallback-avatar-url",
  },
  collaborators: 0,
};

const ProjectDetaillllll = () => {
  const { id } = useParams();
...
export default ProjectDetaillllll;