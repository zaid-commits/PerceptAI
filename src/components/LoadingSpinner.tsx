...
const LoadingSpinner: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col justify-center items-center h-screen ${animation ? 'bg-gradient-to-r from-purple-600 to-pink-600' : 'bg-black'} ${animation ? 'animate-pulse' : ''}`} style={{ backgroundImage: `url('https://i.pinimg.com/originals/ee/6e/d5/ee6ed5945d444fb5046149386acec4c8.gif')`, backgroundSize: 'contain', backgroundPosition: 'center' }}>
