...
function GlassCard() {
  return (
    <div className="container">
      <div data-text="Github" style={{ '--r': '-15' } as React.CSSProperties} className="glass">
      ...
      <div data-text="Code" style={{ '--r': '5' } as React.CSSProperties} className="glass">
      ...
      <div data-text="Earn" style={{ '--r': '25' } as React.CSSProperties} className="glass">
