...
const Chat: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-black text-white">
      <Card className="bg-[#161618] text-white border border-[#8080807a]">
        <CardHeader>
      ...
      <Button onClick={() => navigate('/profile')} className="mt-4 bg-purple-800 text-white hover:bg-purple-900">Your Profile</Button>
    </div>
  );
};
